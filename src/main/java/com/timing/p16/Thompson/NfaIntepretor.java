...
import com.timing.p16.InputSystem.Input;
...
public class NfaIntepretor {
    ...
    public void intepretNfa() {
        //从控制台读入要解读的字符串
        System.out.println("top.dianmu.ccompiler.day16.InputSystem.Input string: ");
        ...
        if (lastAccepted) {
            System.out.println("The top.dianmu.ccompiler.day16.ThompsonConstruction.Nfa Machine can recognize string: " + inputStr);
        }
