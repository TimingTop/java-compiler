...
public class Lexer {
    ...
    private boolean isAlnum(char c) {
		return Character.isAlphabetic(c) == true ||
    ...
    public void runLexer() {
        while (!match(EOI)) {
            if (match(WHITE_SPACE) != true) {
                System.out.println("Token: " + token() + " ,top.dianmu.ccompiler.day65.top.dianmu.ccompiler.day66.top.dianmu.ccompiler.day67.top.dianmu.ccompiler.day68.top.dianmu.ccompiler.day70.Symbol: " + yytext);
            }
            advance();
        }
    }
